...
class FunCog(
    ...
    async def rate(
        ...
        *,
        ...
        await ctx.send(
            f"I rate {member.mention} {rating} out of 10!"
        )
    ...
    async def coin(
        ...
        flipped_value = random.choice(
            possible_responses
        )
        await ctx.send(
            f"You got {flipped_value}!"
        )
    ...
    async def dice(
        ...
        rolled_value = random.choice(
            possible_responses
        )
        await ctx.send(
            f"You rolled a {rolled_value}!"
        )
    ...
    async def rps(
        ...
        if (
            ...
            await ctx.send(
                "You must either say rock, paper, or scissors!"
            )
            return
        embed = discord.Embed(
            title="",
